import {names,escapeHtml as e,scorePapi,scoreDisc,scoreTiu,mapPersonality} from './scoring.js?v=20260923-disc-job-match';
...
export function renderResult(code,attempt,rows,config){
 ...
 const total={test1:90,test2:24,tiu5:30,tiu6:40}[code];
 let values,issues=[];
